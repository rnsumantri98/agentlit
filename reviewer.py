...
st.markdown("Unggah dokumen kontrak Anda untuk mendapatkan analisis mendalam dari OpenAI.")
...
# Pengunggah file
uploaded_file = st.file_uploader("Pilih file dokumen (.txt, .md)", type=['txt', 'md'])

if uploaded_file is not None:
    if st.button("Tinjau Dokumen", disabled=st.session_state.processing):
        with st.spinner("AI sedang menganalisis kontrak... Harap tunggu sebentar."):
            ...
            try:
                ...
                # Simpan nama file dan hasil tinjauan di status sesi
